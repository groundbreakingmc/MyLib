...
public class ConfigUtils {
    ...
    public static <T> ImmutableList<T> getImmutableColorizedStringList(ConfigurationNode node, String path, Colorizer<T> colorizer) throws SerializationException {
