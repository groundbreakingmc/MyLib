...
public class PlayerRegionEntryEvent extends PlayerEvent implements Cancellable {
    ...
    public PlayerRegionEntryEvent(@NotNull LocalPlayer who, @NotNull Set<ProtectedRegion> regions) {
